...
showdown.helper.matchRecursiveRegExp = function(e, r, n, t) {
    ...
    function c(e, r) {
        if (!showdown.helper.isString(e)) throw Error("Inv加载更多alid argument in converter.listen() method: name must be a string, but " + (void 0 === e ? "undefined" : _typeof(e)) + " given");
