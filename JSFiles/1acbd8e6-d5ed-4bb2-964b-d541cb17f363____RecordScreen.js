...
/*-----------------------------------------------------------------*/
            ...
            mediaElement.media.playsinline = false;
            ...
            btnStartRecording.onclick = function(event) {
                ...
                if(button.innerHTML === 'Stop Recording') {
                    console.log("btnStartRecording.onclick 'Stop Recording'");
                ...
                console.log("record audio+screen");
                ...
                if(recordingMedia.value === 'record-audio-plus-video') {
                    ...
                    console.log("captureAudioPlusVideo(commonConfig)");
            ...
            function uploadToPHPServer(fileName, recordRTC, callback) {
                ...
                //var upload_url = 'http://localhost:8383/RecordRTC-master/';
                var upload_url = 'http://localhost:8383/RecordRTC-master/';
            ...
            function getFileName(fileExtension) {
                var IdLlamada=document.getElementById("llamada").value;
                var d = new Date();
                var year = d.getUTCFullYear();
                var month = d.getUTCMonth()+1;
                var date = d.getUTCDate();
                return DEPENDENCIA +" "+ year +"-"+ month +"-"+ date + '-' + IdLlamada + '.' + fileExtension;
            }
