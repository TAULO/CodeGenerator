// ==UserScript==
// @name           KaraMultipage
// @namespace      http://www.karachan.org/
...
AutoPager.prototype.addPage = function(htmlDoc, page) {
    ...
    var hr = document.createElementNS(HTML_NS, 'br')
    ...
    p.innerHTML = 'Strona: <a style="color:red;size:150%;" class="autopagerize_link" href="' +
