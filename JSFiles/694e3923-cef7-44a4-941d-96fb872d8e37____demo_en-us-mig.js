...
$(document).ready(function () {
    ...
    function favoritesExpand() {
        ...
        else if (window.innerWidth >= 501 && window.innerWidth < 700) {
        ...
        else if (window.innerWidth >= 701 && window.innerWidth < 915) {
        ...
        else if (window.innerWidth >= 916 && window.innerWidth < 1000) {
