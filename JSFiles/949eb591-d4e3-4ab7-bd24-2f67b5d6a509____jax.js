...
(function (d, c, i) {
  ...
  var j = function (l) {
    return MathJax.Localization._.apply(
      ...
      [['TeX', l]].concat([].slice.call(arguments, 1))
    );
  };
      ...
      for (var m in l) {
        if (l.hasOwnProperty(m)) {
          if (
            ...
            (typeof o[m] === 'object' || typeof o[m] === 'function')
          ) {
  ...
  var a = MathJax.Object.Subclass({
    ...
    UnderOver: function (n, q, l) {
      ...
      m.data[m[p]] = this.mmlToken(
        h.mo(h.entity('#x' + q)).With({ stretchy: true, accent: p == 'under' })
      );
      this.Push(m);
    },
    Overset: function (l) {
    ...
    MakeBig: function (l, o, m) {
      ...
      this.Push(
        h
          .TeXAtom(
            h.mo(n).With({ minsize: m, maxsize: m, fence: true, stretchy: true, symmetric: true })
          )
          .With({ texClass: o })
      );
    },
    ...
    FBox: function (l) {
      this.Push(
        h.menclose.apply(h, this.InternalMath(this.GetArgument(l))).With({ notation: 'box' })
      );
    },
    Not: function (l) {
      this.Push(b.not());
    ...
    Array: function (m, o, t, r, s, n, l, p) {
      ...
      var q = b
        .array()
        .With({ arraydef: { columnalign: r, columnspacing: s || '1em', rowspacing: n || '4pt' } });
      if (u.match(/[|:]/)) {
        if (u.charAt(0).match(/[|:]/)) {
          q.frame.push('left');
        ...
        if (p.data[q]) {
          if (p.isa(h.mrow)) {
            while (
              ...
              o.isa(h.mo) &&
              n.isa(h.mo) &&
              o.Get('texClass') === h.TEXCLASS.REL &&
              n.Get('texClass') === h.TEXCLASS.REL
            ) {
              if (
                o.variantForm == n.variantForm &&
                o.Get('mathvariant') == n.Get('mathvariant') &&
                o.style == n.style &&
                o['class'] == n['class'] &&
                !o.id &&
                !n.id
