    ...
    var Editr = function(opts) {
        ...
        var __ = {
            ...
            fileContentCallback: function(file, content) {
                ...
                console.log('fileContentCallback');
            ...
            bindNav: function() {
                ...
                navItems.on('click', function(event) {
                    ...
                    if (item.data('type') === 'result') {
                        ...
                        $(aceEditor.container).addClass('active').siblings().removeClass('active');

                        $(".editr__result").addClass("active");
                    ...
                    //导航文件切换
                    opts.navCallback(item.data('type'));
                }).first().trigger('click');
        ...
        var init = function() {
            ...
            // Count files
            data.filesTotal = data.files['html'].length +
