                    ...
                    _thumbCreator: {
                        ...
                        renderFile: function(file, html, opts) {
                            ...
                            if (file.file && opts.type == "image") {
                                var g = '<img src="' + file.file + '" class="img-fluid" style="width:50px" draggable="false" />',
                                ...
                                y.onload = function(e) {
                                    ...
                                    if (n.templates.canvasImage) {
                                        ...
                                        img.onload = function() {
                                            ...
                                            m.removeClass('fi-loading').html('<img src="' + canvas.toDataURL("image/png") + '" class="img-fluid" style="width:50px" draggable="false" />');
                                        }
                                        ...
                                        m.removeClass('fi-loading').html('<img src="' + e.target.result + '" class="img-fluid" style="width:50px" draggable="false" />');
                                    }
                                }
