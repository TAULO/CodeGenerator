...
(function($) {
	...
	$.fn.fileuploader.defaults = {
        ...
        captions: {
            button: function(options) { return 'არჩევა'; },
            feedback: function(options) { return 'ფაილების ატვირთვა'; },
            feedback2: function(options) { return 'არჩეულია ' + options.length + (options.length > 1 ? ' ფაილი' : ' ფაილი ') + ''; },
