...
(function () {
    ...
    /*jslint nomen: true */
    jQuery.sap.declare("sap.ushell.renderers.fiori2.ShellModel");
    ...
    function ShellModel() {
        ...
        this._showRightFloatingContainer = function (bShow) {
            this._setShellItem("showRightFloatingContainer", bShow, true, [], noValidation, updateModelProperty);
        };
    ...
    sap.ushell.renderers.fiori2.ShellModel = new ShellModel();
}());