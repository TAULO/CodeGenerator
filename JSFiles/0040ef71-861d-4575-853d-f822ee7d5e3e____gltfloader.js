			...
			return scope.loadGeometries(primitives).then(function(geometries) {
				for (var i = 0, il = primitives.length; i < il; i++) {
					...
					var geometry = geometries[i];
                                        ...
                                        //if( primitive.material !== undefined ) console.log( meshDef.name, primitive.material )
                                        ...
                                        if ( material == undefined )
                                        {
                                            ...
                                            dependencies.materials[primitive.material] = material;
                                        }

                                        if ( !scope.options.manager.tempMaterialDict[ primitive.material ] )
                                        {
                                            scope.options.manager.tempMaterialDict[ primitive.material ] = meshDef.name;
                                        }
