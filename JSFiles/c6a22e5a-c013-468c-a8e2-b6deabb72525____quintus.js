    ...
    */
    Q.setup = function (id, options) {
      ...
      if (options.scaleToFit) {
        ...
        Q.el.style.width = "500px";
        Q.el.style.height = "500px";

        if (Q.el.parentNode) {
          Q.el.parentNode.style.width = "500px";
          Q.el.parentNode.style.height = "500px";
        }

        Q.cssWidth = parseInt("500px", 10);
        Q.cssHeight = parseInt("500px", 10);
